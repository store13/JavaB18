...
public class VariablesContinue {
    ...
    public static void main(String[] args) {
        ...
        char ch5 = 'D'; // 68 (corresponding value in ASCII_ Table)
        System.out.println(ch5); // D

        int num1 = 'D'; // number , 68,  take the number due to int
        System.out.println(num1);

        char a1 = 'z';
        // byte b1 = a1;        // char is larger than byte , you can NOT assign
        byte b1 = 'z';

        // short s1 = a1;       // char is larger than short

        int i1 = a1;            // int is larger char
        System.out.println(i1); // 122
