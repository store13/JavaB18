...
public class StaticsReview_BasedOnTheQuiz {
    ...
    public static void main(String[] args) {
        StaticsReview_BasedOnTheQuiz obj1 = new StaticsReview_BasedOnTheQuiz();
        obj1.a = 20;
        obj1.b = 10;

        StaticsReview_BasedOnTheQuiz obj2 = new StaticsReview_BasedOnTheQuiz();
        obj2.a = 30;
        obj2.b = 40;
