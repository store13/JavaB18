...
public class CybertekStudents {
  ...
  class CObjects{
      public static void main(String[] args) {
          CybertekStudents student1 = new CybertekStudents("Adam", 11, "Batch 18");
          student1.schoolName = "MIT";      // there is only one copy share with all objects..
          System.out.println(student1);

          CybertekStudents student2 = new CybertekStudents("Matt", 3, "Batch 18");
