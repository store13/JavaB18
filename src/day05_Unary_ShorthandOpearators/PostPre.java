...
public class PostPre {
    ...
    public static void main(String[] args) {
        ...
        // (Think like postpone transaction )
        ...
        double t1 = 3.5;
        double t2 = t1--;    // 3.5, after line 41 t1 it will be decreased by 1

        System.out.println(t2); // 3.5
        System.out.println(t1); // 2.5

        int num = 35;
        System.out.println(num++);  // 35, after line 47, the value of num will be 36
        System.out.println(num--);  // 36, after line 48, the value of num will be 35
